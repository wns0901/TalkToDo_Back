...
import com.example.TalkToDo.entity.ScheduleCategory;
import com.example.TalkToDo.entity.ScheduleType;
...
public class TodoService {
    ...
    public ScheduleDTO addTodoToCalendar(Long todoId) {
        ...
        schedule.setUser(todo.getUser());
        schedule.setTitle(todo.getTitle());
        schedule.setStartDate(java.time.LocalDate.now());
        schedule.setEndDate(java.time.LocalDate.now());
        schedule.setCategory(ScheduleCategory.TODO);
        schedule.setType(ScheduleType.TODO);
        schedule.setCompleted(todo.isCompleted());
        schedule.setTodo(true);
        schedule.setDisplayInCalendar(true);
        schedule.setOriginalTodoId(todo.getId());
